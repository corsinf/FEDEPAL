...
<html prefix="og: http://ogp.me/ns#" lang="es-ES" dir="ltr">
	<head>
		<title><?php echo isset($product['seo']['tagTitle']) ? $product['seo']['tagTitle'] : ''; ?> - Fedepal</title>
		<meta charset="utf-8" />
...
<link rel="stylesheet" href="../res/swiper-bundle.min.css?2024-4-8-0" />
		...
		<link rel="stylesheet" href="../product/style.css?2024-4-8-0-638702834725588474" media="screen,print" />
		<script src="../res/jquery.js?2024-4-8-0"></script>
		<script src="../res/x5engine.js?2024-4-8-0" data-files-version="2024-4-8-0"></script>
<script src="../res/swiper-bundle.min.js?2024-4-8-0"></script>		<script src="../res/x5engine.elements.js?2024-4-8-0"></script>
		<script src="../res/handlebars-min.js?2024-4-8-0"></script>
		<script src="../res/card-ecommerce.js?2024-4-8-0"></script>
		...
		<link rel="icon" href="../favicon.png?2024-4-8-0-638702834725250463" type="image/png" />
<?php
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden"><?php echo isset($product['name']) ? $product['name'] : ''; ?> - Fedepal</h1>
...
$(function () {$('#imStickyBar_imMenuObject_02_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_02_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_02_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
					...
					<main id="imContent">
						...
						<script>x5engine.boot.push('x5engine.cart.productDetails.init({ target: \'im-product-container\', showRelatedProducts: true, innerWidths: \[1140,710,470,0]\, videoHiresWidth: 2560, videoHiresHeight: 1440, minThumbSize: 48, galleryWidthPerc: 50, galleryHeightPx: 400, galleryThumbnailHeightPx: 64 })', false, 6);</script>
	...
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_11_tab0" style="opacity: 1; ">
		...
		<script src="../cart/x5cart.js?2024-4-8-0-638702834725588474"></script>
