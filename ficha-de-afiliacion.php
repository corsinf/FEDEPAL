            ...
            <div class="col-lg-10">
                <div class="card border-0 rounded-4 shadow">
                    <div class="card-body p-5">
                        <h2 class="titulo fw-bold mb-5 pb-3 border-bottom">Proceso de Afiliación</h2>
                        
                        <div class="row g-4 mb-5">
                            <div class="col-12 mb-4 text-center">
                                <h3 class="fw-bold titulo">Beneficios para Socios FEDEPAL</h3>
                                <p class="lead texto-parrafos">Únete a la Federación de Establecimientos de Educación Particular Laica</p>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 border-0 shadow-sm text-center p-4 rounded-4 hover-translate-y">
                                    ...
                                    <ul class="list-unstyled texto-parrafos mb-0">
                                        ...
                                        <li class="mb-2">Actualización docente permanente</li>
                                        <li class="mb-2">Talleres especializados</li>
                                        <li>Certificaciones educativas</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 border-0 shadow-sm text-center p-4 rounded-4 hover-translate-y">
                                    ...
                                    <ul class="list-unstyled texto-parrafos mb-0">
                                        ...
                                        <li class="mb-2">Consultoría administrativa</li>
                                        <li class="mb-2">Orientación normativa</li>
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 border-0 shadow-sm text-center p-4 rounded-4 hover-translate-y">
                                    ...
                                    <ul class="list-unstyled texto-parrafos mb-0">
                                        ...
                                        <li class="mb-2">Herramientas de gestión</li>
                                        <li class="mb-2">Biblioteca digital</li>
                                        <li>Recursos innovadores</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ps-4 border-start border-4 border-violeta bg-white p-4 rounded-3 shadow-sm mb-4 hover-translate-x">
                            ...
                            <div class="ms-4 mt-3">
                                <ul class="list-unstyled texto-parrafos">
                                    ...
                                    <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Dirección completa</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Teléfono y móvil de contacto</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Correo Electrónico Institucional</li>
