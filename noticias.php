...
<!-- End Google Tag Manager (noscript) -->
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden">News - Fedepal</h1>
						...
						<header>
								...
								<div class="container my-5">
									<div class="row">
										...
										<div class="col-md-4 mb-4">
											<div class="news-card">
												<img src="https://via.placeholder.com/300" alt="Noticia 2" class="news-image">
												<h4 class="news-title">Noticia 2</h4>
												<p class="news-content">xxxx.</p>
												<!-- Botón que activa el modal -->
												<a href="#" class="btn btn-read-more" data-bs-toggle="modal" data-bs-target="#modalNoticia2">Leer más</a>
											</div>
										</div>
										<!-- Tarjeta 3 -->
										<div class="col-md-4 mb-4">
											<div class="news-card">
												<img src="https://via.placeholder.com/300" alt="Noticia 3" class="news-image">
												<h4 class="news-title">Noticia 3</h4>
												<p class="news-content">xxxx.</p>
												<!-- Botón que activa el modal -->
												<a href="#" class="btn btn-read-more" data-bs-toggle="modal" data-bs-target="#modalNoticia3">Leer más</a>
											</div>
										</div>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title" id="modalNoticia1Label">Detalles de Noticia 1</h5>
												<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
											</div>
											<div class="modal-body">
												Texto, imágenes o cualquier otro contenido necesario para Noticia 1.
											</div>
