...
<html prefix="og: http://ogp.me/ns#" lang="es-ES" dir="ltr">
	<head>
		<title>Ficha de Afiliacion - Fedepal</title>
		<meta charset="utf-8" />
		...
		<link rel="stylesheet" href="pcss/ficha-de-afiliacion.css?2024-4-4-0-638676382339289835" media="screen,print" />
		...
		<script>
			...
			x5engine.utils.currentPagePath = 'ficha-de-afiliacion.php';
			x5engine.boot.push(function () { x5engine.utils.imCodeProtection('Corsinf'); });
			x5engine.boot.push(function () { x5engine.imPageToTop.initializeButton({}); });
		</script>
		<link rel="icon" href="favicon.png?2024-4-4-0-638676382339185892" type="image/png" />
	</head>
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden">Ficha de Afiliacion - Fedepal</h1>
...
$(function () {$('#imStickyBar_imMenuObject_02_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_02_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_02_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
					...
					<main id="imContent">
						...
						<div id="imCell_5" class=""> <div id="imCellStyleGraphics_5"></div><div id="imCellStyleBorders_5"></div><div id="imObjectButton_16_05"><button type="button" id="imObjectButton_16_05_button" onclick="x5engine.imShowBox({ media:[{type: 'iframe', url: 'https://docs.google.com/spreadsheets/d/1SNCD1P8B2v01W9bXbhKjbQSE-r_hUa1Xa9dCh1OFDFc/edit?usp=sharing', width: 1920, height: 1080, description: ''}]}, 0, this);">FICHA DE AFILIACION</button></div></div><div id="imCell_4" class=""> <div id="imCellStyleGraphics_4"></div><div id="imCellStyleBorders_4"></div><div id="imObjectButton_16_04"><button type="button" id="imObjectButton_16_04_button" onclick="x5engine.imShowBox({ media:[{type: 'iframe', url: 'files/POLITICA-MEMBRESIAS-2024.pdf', width: 1920, height: 1080, description: ''}]}, 0, this);">REQUISITOS PARA LA AFILIACION</button></div></div>
					</main>
					<footer id="imFooter">
