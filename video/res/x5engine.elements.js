...
//    titleContentHeight: {},
    // Possible values of titleContentHeight:
    // Altezza in pixel del blocco di titolo+contenuti
    // titlecontentheight="250"
  ...
  render() {   
    ...
    } else if ( this.contentLayout == "vertical-cover-top" ) {
      generalStyle = generalStyle +
        `:host slot[name=cover]::slotted(*) { 
          grid-column:1/2; 
          grid-row:1/2; 
    ...
    if ( this.contentLayout == "vertical-title-top" || this.contentLayout == "horizontal-cover-left" || this.contentLayout == "horizontal-cover-right" ) {
      if ( this.contentLayout == "horizontal-cover-left" || this.contentLayout == "horizontal-cover-right" )
        generalStyle = generalStyle + "\n@media (max-width: " + mobileBPMaxWidth + "px) {";
...
class CardLayout extends dt {
  ...
  render() {
    ...
    if ( this.firstElementChild.contentLayout == "horizontal-cover-left" || this.firstElementChild.contentLayout == "horizontal-cover-right" )
      allCSS += "\n@media (min-width: " + (mobileBPMaxWidth + 0.1) + "px) {";
