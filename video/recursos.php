...
<html prefix="og: http://ogp.me/ns#" lang="es-ES" dir="ltr">
	<head>
		...
		<meta property="og:url" content="http://localhost/recursos.php" />
		...
		<style type="text/css">#pluginAppObj_13_12 { width: 100%; }</style>
		<link rel="stylesheet" href="pluginAppObj/imHeader_pluginAppObj_04/custom.css" media="screen, print" />
		<link rel="stylesheet" href="pluginAppObj/imFooter_pluginAppObj_12/custom.css" media="screen, print" />
		<link rel="stylesheet" href="pcss/recursos.css?2024-4-4-0-638676382339860195" media="screen,print" />
		...
		<script>
			...
			x5engine.utils.currentPagePath = 'recursos.php';
			x5engine.boot.push(function () { x5engine.utils.imCodeProtection('Corsinf'); });
			x5engine.boot.push(function () { x5engine.imPageToTop.initializeButton({}); });
		</script>
		<link rel="icon" href="favicon.png?2024-4-4-0-638676382339555451" type="image/png" />
	</head>
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden">Recursos - Fedepal</h1>
...
$(function () {$('#imStickyBar_imMenuObject_02_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_02_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_02_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
					...
					<main id="imContent">
						...
						</div><div id="imCell_18" class=""> <div id="imCellStyleGraphics_18"></div><div id="imCellStyleBorders_18"></div><div id="imObjectImage_13_18"><div id="imObjectImage_13_18_container"><img src="images/large-5662435.png" title="" alt="" width="530" height="353" />
