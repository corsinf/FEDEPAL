...
<html prefix="og: http://ogp.me/ns#" lang="es-ES" dir="ltr">
	<head>
		<title>Página de Entrada - Fedepal</title>
		<meta charset="utf-8" />
		...
		<meta name="description" content="Federacion de establecimientos de Educacion Particular Laica" />
		<meta property="og:locale" content="es" />
		<meta property="og:type" content="website" />
		<meta property="og:url" content="http://localhost/index.php" />
		<meta property="og:title" content="Página de Entrada" />
		...
		<link rel="stylesheet" href="pcss/index.css?2024-4-4-0-638676382339228349" media="screen,print" />
		<script src="res/jquery.js?2024-4-4-0"></script>
		<script src="res/x5engine.js?2024-4-4-0" data-files-version="2024-4-4-0"></script><script>x5engine.settings.autoHeight.enabled = false;</script>
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden">Página de Entrada - Fedepal</h1>
						<!-- HeaderObjects -->
					</header>
					...
					<main id="imContent">
						...
						<div id="imCell_1" class=""> <div id="imCellStyleGraphics_1"></div><div id="imCellStyleBorders_1"></div><div id="imObjectImage_01"><div id="imObjectImage_01_container"><a href="home.html" onclick="return x5engine.utils.location('home.html', null, false)"><img src="images/anos-de-existencia-Fedepal.jpg" title="" alt="" width="320" height="320" />
